...
This repo is included in Specializations - Web Stack programming ― Back-end Course of Holberton School. We will cover the `Personal Data` concept for backend folder.
...
At the end of this project, you are expected to be able to [explain to anyone](https://intranet.hbtn.io/rltoken/s1IyusR-fEOKN0A4r25uaw "explain to anyone"), **without the help of Google**:
...
Use [user\_data.csv](https://intranet.hbtn.io/rltoken/VdXil8kgV6jOCkJXfsRQbA "user_data.csv") for this task
